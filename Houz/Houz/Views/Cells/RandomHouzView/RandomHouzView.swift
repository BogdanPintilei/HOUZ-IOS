...
class RandomHouzView: UIView {
    ...
    @IBOutlet var houzImageView: UIImageView!

    var houz: Houz! { didSet { configureViewWithHouz() } }
    ...
    private func configureViewWithHouz() {
        houzImageView.image = houz.profileImage
    }
