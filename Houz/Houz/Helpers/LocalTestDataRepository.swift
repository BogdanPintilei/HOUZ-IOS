...
class FeedRepository {
    ...
    class func feed() -> [FeedItem] {
        let feed = [
            ...
            FeedItem(id: 5, type: FeedItemType.product, title: "Cool House Product", itemDescription: "This is a product", likeCount: 132, imageURL: "https://www.thesmartswarm.com/wp-content/uploads/2018/02/50-best-interior-design-projects-by-kelly-wearstler-1.jpg", videoURL: ""),
